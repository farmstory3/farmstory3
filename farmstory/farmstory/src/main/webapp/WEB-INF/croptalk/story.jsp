		...
		<div class="main-box">
			<div class="main-title-box">
				...
				<div class="main-nav-box">
					...
					<div class="nav-latest-icon">></div>
					<div class="nav-tit-3">농작물이야기</div>
				</div>
			</div>
			...
			<c:when test="${write.equals(write)}">
				<main>
                	...
                	-->
							<form
								action="/farmstory/article/write.do?write=write&group=croptalk&cate=story"
			...
			<section class="view">
				...
				<div>
					<a href="/farmstory/article/delete.do?group=croptalk&cate=story&pg=${pg}&no=${articleDto.no}" class="btnDelete">삭제</a> <a href="#" class="btnModify">수정</a>
					<a href="/farmstory/article/list.do?group=croptalk&cate=story&pg=${pg}" class="btnList">목록</a>
				</div>
			...
			<c:otherwise>
				<section class="list">
					...
					<article>
						<table border="0">
							...
							<c:forEach var="article" items="${articles}">
								<tr>
									<td>${pageStartNum}</td>
									<td><a href="/farmstory/article/view.do?group=croptalk&cate=story&view=view&no=${article.no}&pg=${currentPageNum}"">${article.title}</a>&nbsp;[${article.comment}]</td>
									<td>${article.nick}</td>
									<td>${article.rdate}</td>
									<td>${article.hit}</td>
								</tr>
					...
					<!-- 글쓰기 버튼 -->
					<a
						href="/farmstory/article/write.do?write=write&group=croptalk&cate=story"
