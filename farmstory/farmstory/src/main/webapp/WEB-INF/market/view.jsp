...
<script>
	...
	window.onload = function() {
		...
		const realdel = parseInt(del.value,10);
		
		del.value = (parseInt(del.value,10))+'원';
		
		price.value = (parseInt(price.value,10))+'원';
		if(parseInt(price.value,10) <= 30000){
			total.value = (parseInt(price.value,10)+parseInt(del.value,10))+'원';
			del.value = realdel + '원';
		} else{
			total.value = (parseInt(price.value,10))+'원';
			del.value = 0 +'원';
		}
		...
		stock.oninput = function() {
			...
			const t_value =(parseInt(price.value,10));
			const s_value = stock.value;
				
			if(t_value*stock.value < 30000){
				total.value = (t_value*stock.value)+parseInt(del.value,10)+'원';
				del.value = realdel + '원';
				
			}else{
				total.value = (t_value*stock.value)+'원';
				del.value = 0 +'원';
			}
    ...
    <div class="main-box">
            ...
            <div class="main-gubun-box">
                <div class="frame18-article">
                    ...
                    <form action="/farmstory/market/cart.do" method="post" class="frame18-container1">
                      ...
                      <div class="frame18-table">
                        <div class="frame18-body">
                          <div class="frame18-row2">
                            ...
                            <span class="frame18-text39"><input name="prod_name" value="${product.prod_name}"></span>
                          </div>
                          <div class="frame18-row3">
                            <span class="frame18-text41"><span>상품코드</span></span>
                            <span class="frame18-text43"><input name="prod_idx" value="${product.prod_idx}" ></span>
                          </div>
                          <div class="frame18-row4">
                            <span class="frame18-text45"><span>배송비</span></span>
                            <div class="frame18-data4">
                              <span class="frame18-text47">
                                <input class="frame18-text48" name="deliveryFee" value="0" >
                          ...
                          <div class="frame18-row5">
                            ...
                            <span class="frame18-text52"><input name="price" value="${product.price}" class="price"></span>
                          </div>
                          <div class="frame18-row6">
                            <span class="frame18-text54"><span>구매수량</span></span>
                            <div class="frame18-data-input">                     
                               <input type="number" name="quantity" class="stock" min="0" value="1"/> 
                            </div>
                          </div>
                          <div class="frame18-row7">
                            <span class="frame18-text57"><span>합계</span></span>
                            <span class="frame18-text59"><input name="sum" class="total" value ="${product.price}" ></span>
                          </div>
                        </div>
                      </div>
                      <button type="submit" class="frame18-link5">
