...
<body>
	...
	<div class="header-bottom-img">
		<div class="header-bottom-comm">
			<img src="/farmstory/images/sub_top_tit5.png" alt="bottom-img">  <!-- 수정 -->
		</div>
	</div>
</div>
		...
		<div class="sidebar-box">
			...
			<div class="sidebar-bg-box">
				<a href="/farmstory/article/list.do?group=community&cate=notice"/>
					...
					<div class="sidebar-item _04 _ov"></div>
		...
		<div class="main-box">
			<div class="main-title-box">
				...
				<div class="main-nav-box">
					...
					<div class="nav-latest-icon">></div>
					<div class="nav-tit-3">1:1고객문의</div>
				</div>
			</div>
			...
			<c:when test="${write.equals(write)}">
				<main>
                	...
                	-->
							<form
								action="/farmstory/article/write.do?write=write&group=community&cate=qna"
			...
			<section class="view">
				...
				<div>
					<a href="/farmstory/article/delete.do?group=community&cate=qna&pg=${pg}&no=${articleDto.no}" class="btnDelete">삭제</a> <a href="#" class="btnModify">수정</a>
					<a href="/farmstory/article/list.do?group=community&cate=qna&pg=${pg}" class="btnList">목록</a>
				</div>
			...
			<c:otherwise>
				<section class="list">
					...
					<article>
						<table border="0">
							...
							<c:forEach var="article" items="${articles}">
								<tr>
									<td>${pageStartNum}</td>
									<td><a href="/farmstory/article/view.do?group=community&cate=qna&view=view&no=${article.no}&pg=${currentPageNum}"">${article.title}</a>&nbsp;[${article.comment}]</td>
									<td>${article.nick}</td>
									<td>${article.rdate}</td>
									<td>${article.hit}</td>
								</tr>
					...
					<!-- 글쓰기 버튼 -->
					<a
						href="/farmstory/article/write.do?write=write&group=community&cate=qna"
