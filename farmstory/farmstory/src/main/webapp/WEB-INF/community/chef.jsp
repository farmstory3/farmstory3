		...
		<div class="main-box">
			...
			<c:when test="${write.equals(write)}">
				<main>
                	...
                	-->
							<form
								action="/farmstory/article/write.do?write=write&group=community&cate=chef"
			...
			<section class="view">
				...
				<div>
					<a href="/farmstory/article/delete.do?group=community&cate=chef&pg=${pg}&no=${articleDto.no}" class="btnDelete">삭제</a> <a href="#" class="btnModify">수정</a>
					<a href="/farmstory/article/list.do?group=community&cate=chef&pg=${pg}" class="btnList">목록</a>
				</div>
			...
			<c:otherwise>
				<section class="list">
					...
					<article>
						<table border="0">
							...
							<c:forEach var="article" items="${articles}">
								<tr>
									<td>${pageStartNum}</td>
									<td><a href="/farmstory/article/view.do?group=community&cate=chef&view=view&no=${article.no}&pg=${currentPageNum}"">${article.title}</a>&nbsp;[${article.comment}]</td>
									<td>${article.nick}</td>
									<td>${article.rdate}</td>
									<td>${article.hit}</td>
								</tr>
					...
					<!-- 글쓰기 버튼 -->
					<a
						href="/farmstory/article/write.do?write=write&group=community&cate=chef"
