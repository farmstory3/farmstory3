...
<link rel="stylesheet" href="/farmstory/css/info.css">
...
<body>
	...
	<div class="header-bottom-img">
		<div class="header-bottom-comm">
			<img src="/farmstory/images/sub_top_tit4.png" alt="bottom-img">  <!-- 수정 -->
		</div>
	</div>
</div>
		...
		<div class="main-box">
			<div class="main-title-box">
				...
				<div class="main-nav-box">
					...
					<div class="nav-tit-2">이벤트</div>
					<div class="nav-latest-icon">></div>
					<div class="nav-tit-3">이벤트</div>
				</div>
			</div>
			...
			<c:when test="${write.equals(write)}">
				<main>
                	...
                	-->
							<form
								action="/farmstory/article/write.do?write=write&group=event&cate=info"
			...
			<section class="view">
				...
				<div>
					<a href="/farmstory/article/delete.do?group=event&cate=info&pg=${pg}&no=${articleDto.no}" class="btnDelete">삭제</a> <a href="#" class="btnModify">수정</a>
					<a href="/farmstory/article/list.do?group=event&cate=info&pg=${pg}" class="btnList">목록</a>
				</div>
			...
			<c:otherwise>
				<section class="list">
					...
					<article>
						<table border="0">
							...
							<c:forEach var="article" items="${articles}">
								<tr>
									<td>${pageStartNum}</td>
									<td><a href="/farmstory/article/view.do?group=event&cate=info&view=view&no=${article.no}&pg=${currentPageNum}"">${article.title}</a>&nbsp;[${article.comment}]</td>
									<td>${article.nick}</td>
									<td>${article.rdate}</td>
									<td>${article.hit}</td>
								</tr>
					...
					<!-- 글쓰기 버튼 -->
					<a
						href="/farmstory/article/write.do?write=write&group=event&cate=info"
