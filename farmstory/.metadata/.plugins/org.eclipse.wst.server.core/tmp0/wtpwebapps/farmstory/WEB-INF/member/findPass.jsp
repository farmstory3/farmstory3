...
<script src="/farmstory/js/findPass.js"></script>
<style>
    .move{
        margin-left: 475px;
    }
                ...
                <form action="#" method="POST">
                    <table border="1">
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <button  type="button" id="btnCheckUid"><img src="/farmstory/images/chk_confirm.gif" alt=""></button>
                    ...
                    <table border="1">
                        <caption class="move">
                            ...
                            <a href="/farmstory/member/findPass.do">아이디찾기</a>
                        </caption>
                    </table>
                </form>
            </section>
